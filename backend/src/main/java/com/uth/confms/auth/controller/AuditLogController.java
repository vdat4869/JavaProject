 ...
 *
 * <ul>
 *   <li>GET /api/audit-logs - List audit logs với filters và pagination (ADMIN only)
...
public class AuditLogController {
    ...
    public ResponseEntity<ApiResponse<Page<AuditLogDTO>>> getAuditLogs(
        ...
        log.debug("Querying audit logs with filters: userId={}, action={}, resource={}, resourceId={}, startDate={}, endDate={}, page={}, size={}",
        ...
        Page<AuditLog> auditLogs = auditLogRepository.findWithFilters(
                userId, action, resource, resourceId, startDateTime, endDateTime, pageable);
    ...
    public ResponseEntity<byte[]> exportAuditLogs(
        ...
        log.info("Exporting audit logs with filters: userId={}, action={}, resource={}, resourceId={}, startDate={}, endDate={}, format={}",
    ...
    private byte[] exportToCsv(List<AuditLog> auditLogs) {
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            throw new com.uth.confms.common.exception.BusinessException("Failed to export audit logs: " + e.getMessage());
        }
    }
