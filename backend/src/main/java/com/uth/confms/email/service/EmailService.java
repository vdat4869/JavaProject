 ...
 *
 * <p>Service này cung cấp các operations để gửi email:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>Templates được lưu tại: resources/templates/email/
 *
...
public interface EmailService {
   ...
   * @param templateName Tên template (không bao gồm extension, ví dụ: "verification" cho
   *     "verification.html")
