 ...
 * <p>Endpoints:
 * <ul>
 *   <li>POST /api/storage/backup/conference/{conferenceId} - Create backup cho conference
 *   <li>POST /api/storage/backup/all - Create full backup
 *   <li>POST /api/storage/backup/{backupId}/restore - Restore từ backup
 *   <li>POST /api/storage/backup/conference/{conferenceId}/restore - Restore conference từ latest backup
 *   <li>GET /api/storage/backup/conference/{conferenceId} - Get backup history cho conference
